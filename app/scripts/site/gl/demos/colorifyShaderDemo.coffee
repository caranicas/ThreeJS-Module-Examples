...
ColorifyShader = require 'colorifyshader'

DemoInterface = require './DemoInterface'


class ColorifyShaderDemo extends DemoInterface
  ...
  __createShaderEffects: ->
    effect = new EffectComposer.prototype.ShaderPass(new ColorifyShader())
    effect.renderToScreen = true;
    effect.uniforms[ "color" ].value = new THREE.Color(0xff0000)
...
module.exports = ColorifyShaderDemo
